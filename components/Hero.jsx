    ...
    <>
      <div className="bg-[url(/img/bg.png)]  relative bg-black bg-cover     bg-no-repeat bg-center pb-[100px] h-full">
        <div className='w-full  justify-between  flex  items-center   h-[100px] '>
          <div className="w-[200px] flex items-center h-[100px] bg-white">
            <Image alt='' className='pl-[20px]  w-[150px] h-[60px]' src={logo} width={150} height={60} />
          </div>
        ...
        <div className=" ">
          ...
          {/* <div className="   w-[300px]  absolute top-[100px]  max-2xl:hidden left-[1100px]">
            <Image alt='' className='  ' src={kaja} width={300} height={200} />
          </div> */}
      ...
      <div className='max-w-[1440px] w-full     mx-auto ' >
        ...
        <div className=" h-full items-center max-xl:pt-[50px]  pb-[50px]  px-[12px]  md:flex max-w-[1000px] relative  w-full mx-auto justify-between  ">
          ...
          <div className=" -z-40">
            <Image className='w-[400px] h-[500px]' alt='' src={mask} width={400} height={500} />
          </div>
          ...
          <div className="max-xl:pt-[50px]   -z-40 pl-[20px] ">
            ...
            <div>
              <Image alt='' className=' w-[200px] h-[20]  max-xl:hidden absolute  top-[60px] right-[-30px]' src={Group} width={200} height={200} />
            </div>
          </div>
        ...
        <div className="h-[200px] w-full bg-[#f8f3f3] flex items-center">
          <div style={{ overflowY: 'scroll', }} className="flex gap-11    overflow-scroll   mx-auto ">
            <Image className='w-[200px] h-[200] ' alt='' src={img1} width={200} height={200} />
            <Image className='w-[200px] h-[200] ' alt='' src={img2} width={200} height={200} />
            <Image className='w-[200px] h-[200] ' alt='' src={img3} width={200} height={200} />
            <Image className='w-[200px] h-[200] ' alt='' src={img4} width={200} height={200} />
            <Image className='w-[200px] h-[200] ' alt='' src={img5} width={200} height={200} />
          </div>
        </div>


        <div className="flex   overflow-scroll">
          <Image className='w-[500px] h-[400] ' alt=''   src={part1} width={500} height={400} />
          {/* <p className=" relative  text-[25px] text-white pt-[00px]" > The Ultima</p> */}
          <Image className='w-[500px] h-[400] ' alt='' src={part2} width={500} height={400} />
          <Image className='w-[500px] h-[400] ' alt='' src={part3} width={500} height={400} />
        ...
        <div className="pt-[150px]  max-w-[1100px] pb-[100px] px-[12px] w-full mx-auto ">
          ...
          <div className=" xl:flex grid-cols-2 max-md:grid-cols-1 grid   justify-center   gap-4 overflow-scroll">
            ...
            <div className="flex  mx-auto max-w-[400px]    w-full  gap-4 pt-[100px]">
              <div className="  max-w-[400px]  w-full       hover:bg-black bg-[#f5f1f1] h-full  pb-[50px]  ">
                <div className="  ">
                  <div className="flex justify-center"> <Image className=' w-[200px] h-[150px]  pt-[30px]' src={iconbox2} width={200} height={150} /></div>
            ...
            <div className="flex mx-auto  justify-center max-w-[400px] group-hover:text-white  w-full  gap-4 pt-[100px]">
              <div className="  max-w-[400px]  w-full    hover:bg-black   bg-[#f5f1f1] h-full  pb-[50px]  ">
                <div className="  ">
                  <div className="flex justify-center"> <Image className=' h-[150px] w-[160px]  pt-[30px]' src={iconbox3} width={160} height={150} /></div>
        ...
        <div className="flex flex-wrap mx-auto max-w-[1440px] w-full justify-center">
          ...
          <Image className='w-[480px] h-[200px]' alt='' src={immg1} width={480} height={200} />


          <Image className='w-[480px] h-[200px]' alt='' src={immg2} width={480} height={200} />



          <Image className='w-[480px] h-[200px]' alt='' src={immg3} width={480} height={200} />

          <Image className='w-[480px] h-[200px]' alt='' src={immg4} width={480} height={200} />


          <Image className='w-[480px] h-[200px]' alt='' src={immg5} width={480} height={200} />



          <Image className='w-[480px] h-[200px]' alt='' src={immg6} width={480} height={200} />
        ...
        <div className="max-w-[1100px]  px-[15px]   pt-[100px]  xl:flex w-full mx-auto">
          <div className="md:flex md:justify-center  mx-auto max-w-[550px] w-full justify-between">
            <div>
              <Image className='w-[200px] h-[500px]' alt='' src={srceen1} width={200} height={500} />
            </div>
          ...
          <div className=" max-w-[550px] mx-auto    max-xl:pt-[100px]  md:pl-[100px] w-full justify-between">
            <div>
              <Image className='w-[500px] h-[500px]' alt='' src={srceen2} width={500} height={500} />
            </div>
            <div>
        ...
        <div className="    pt-[150px] px-[10px]  xl:flex grid-cols-2 max-md:grid-cols-1 grid   justify-center   gap-4 overflow-scroll">
          ...
          <div className="max-w-[500px] mx-auto   h-full pb-[50px] border-[1px] border-[#929191] p-[10px]">
            <Image className='w-[480px] h-[200px]' alt='' src={one} width={480} height={200} />
          ...
          <div className="max-w-[500px] mx-auto h-full pb-[50px] border-[1px] border-[#929191] p-[10px]">
            <Image className='w-[480px] h-[200px]' alt='' src={two} width={480} height={200} />
            <p className="text-[16px] pt-[20px] text-[#c0bfbf]">MARCH 20 2020 .. TOM BLACK</p>
            ...
            <Image className='w-[480px] h-[200px]' alt='' src={three} width={480} height={200} />
            <p className="text-[16px] pt-[20px] text-[#c0bfbf]">MARCH 20 2020 .. TOM BLACK</p>
